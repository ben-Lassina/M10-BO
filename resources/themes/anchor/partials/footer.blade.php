    ...
    <x-container>
        <div class="flex flex-wrap items-start justify-between pb-20 ">
            <a href="{{ route('home') }}"class="">
                <x-logo class="flex items-center justify-center space-x-3 font-bold text-zinc-900 transition-transform duration-300 hover:scale-105 hover:rotate-3"></x-logo>
            </a>
